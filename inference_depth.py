...
HOME_DIR = '/content/depth_from_video_in_the_wild'
DEFAULT_OUTPUT_DIR = '/content/depth_from_video_in_the_wild/inference'
DEFAULT_KITTI_DIR = '/content/drive/MyDrive/Dự án/KITTI Dataset/Raw Data'
...
def _run_inference():
    ...
    with sv.managed_session() as sess:
        ...
        for i in range(0, len(im_files), FLAGS.batch_size):
            ...
            results = inference_model.inference_depth(inputs, sess)
